...
class Produtos extends CI_Controller {
	...
	public function novo() {
		...
		$this->form_validation->set_rules("nome", "nome", "required|min_length[10]|callback_banao_tenha_a_palavra_melhor");
		$this->form_validation->set_rules("descricao", "descricao", "trim|required|min_length[10]|nao_tenha_a_palavra_melhor");
